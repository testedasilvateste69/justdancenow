! function() {
    ...
    a.prototype.needsClick = function(a) {
        ...
        return "none" === a.style.msTouchAction || "manipulation" === a.style.touchAction || (!!((f = +(/Firefox\/([0-9]+)/.exec(navigator.userAgent) || [, 0])[1]) >= 27 && (b = document.querySelector("meta[name=viewport]")) && (-1 !== b.content.indexOf("user-scalable=no") || document.documentElement.scrollWidth <= window.outerWidth)) || ("none" === a.style.touchAction || "manipulation" === a.style.touchAction))
